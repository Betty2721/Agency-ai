...
const Servicecard = ({service, index}) => {
  ...
  return (
    <div className='relative overflow-hidden max-w-lg m-2 sm:m-4 rounded-xl border
      border-gray-200 dark:border-gray-700 shadow-2xl sadow-gray-100
      ...
      ref={divRef} onMouseMove={handleMouseMove}>
        ...
        transtion-opacity duration-500 mix-blend-lighten ${visible ? 'opacity-70' : 
        'opacity-0'}`} style={{top: position.y - 150, left: position.x - 150}} />

            <div className='flex items-center gap-10 p-8 hoveer:p-7.5 hover:m-0.5
              transtion-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
