  ...
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12
        ...
        dark:text-white'>
            ...
            <div className='inline-flex items-center gap-2 border-gray-300 p-1.5
                 pr-4 rounded-full'>
                <img className='w-20' src={assets.group_profile} alt=""/>
                <p className='text-xs font-medim'>Trusted by 10k+ people</p>
            </div>
            ...
            <h1 className='text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium
              ...
              <p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/
                 75 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and turning big ideas into interactive 
